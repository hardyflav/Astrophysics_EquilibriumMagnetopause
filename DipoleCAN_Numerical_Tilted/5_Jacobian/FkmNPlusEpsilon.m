...
function [FkmNPlusEpsilon] = FkmNPlusEpsilon(rGrid, epsilon, ParaGrid, ParaSystem)
...
% Partial Derivatives
    ...
    rGrid_mNphiPlusEpsilon = rGrid_mNphi + epsilon;
    ...
    drdthetaGrid_BWD = (rGrid - rGrid_mNphiPlusEpsilon) ./ (DeltaTheta);
    drdthetaGrid_FWD = (rGrid_pNphi - rGrid) ./ (DeltaTheta);
    drdthetaGrid_Central = (rGrid_pNphi - rGrid_mNphiPlusEpsilon) ./ (2*DeltaTheta);
...
%% Pressure Balance
    ...
    FkmNPlusEpsilon = ( (PressureDifference) ./  PressureAverage );

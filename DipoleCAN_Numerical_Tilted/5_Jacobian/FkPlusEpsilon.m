...
function [FkPlusEpsilon] = FkPlusEpsilon(rGrid, epsilon, ParaGrid, ParaSystem)
    ...
    rGridPlusEpsilon = rGrid + epsilon;
...
% Partial Derivatives
    ...
    rRight = 2 * rGridPlusEpsilon(:, end) - rGrid_mNphi(:, end);
    ...
    drdthetaGrid_BWD = (rGridPlusEpsilon - rGrid_mNphi) ./ (DeltaTheta);
    drdthetaGrid_FWD = (rGrid_pNphi - rGridPlusEpsilon) ./ (DeltaTheta);
...
%% Pressure Balance
    ...
    FkPlusEpsilon = ( (PressureDifference) ./  PressureAverage );

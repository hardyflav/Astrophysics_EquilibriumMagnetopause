...
function drdthetaA2 = drdthetaA2(r, theta, phi)
...
%         drdthetaA2 = r*( r^6*cos(theta)*sin(theta)+sqrt(r^6-1) ) / ( 1-r^6*sin(theta)^2 );

%         drdthetaA2 =( r*cot(theta)*(-2*M - r^3) ) / ( -4*M+r^3 );



%  drdthetaA2 = (4.*By.^2+4.*Bx.^2.*cos(theta).^2+8.*Bx.*Bz.*cos(theta).*sin( ...

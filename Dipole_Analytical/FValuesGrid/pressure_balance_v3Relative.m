function pressure_balance_v3Relative = pressure_balance_v3Relative( k, r, rss, r_eq, r_mer, delta_theta_deg, delta_phi_deg, Max_deg_equ, Max_deg_phi_direction )
    ...
    pressure_balance_v3Relative = 2*(norm(cross(n_vec, -B)) + (1/2)*dot(n_vec,v))/(norm(cross(n_vec, -B)) - (1/2)*dot(n_vec,v));    

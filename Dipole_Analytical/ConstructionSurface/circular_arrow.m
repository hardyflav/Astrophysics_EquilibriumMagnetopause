function circular_arrow(figHandle, radius, centre, arrow_angle, angle, direction, colour, head_size, head_style, LineWidth)
...
while i < 3
    ...
    plot(v{i}(1,:)+xc,v{i}(2,:)+yc,'Color', colour, 'LineWidth', LineWidth) % Plot arc, centered at P0

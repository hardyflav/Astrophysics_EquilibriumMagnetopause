function JacobianBottom = Jacobian_Bottom(ThetaLeftBoundaryDeg, Max_deg_equ, Max_deg_phi_direction, delta_theta_deg, delta_phi_deg, r, rLeft, r_eq, r_right_outer_boundary, r_mer)
